...
def inject_styles():
    ...
    .stTabs [data-baseweb="tab"] {
        color: #6060a0 !important; font-size: 0.85rem;
        border-radius: 8px; padding: 8px 20px;
    }
    .stTabs [aria-selected="true"] {
        background: #1a1a30 !important; color: #c0c0ff !important;
    }
    .stSelectbox label, .stSlider label {
        color: #9090c0 !important; font-size: 0.82rem;
    }
    .stButton > button {
    ...
    .pred-box h2 {
        color: #b0a0ff !important; font-size: 1rem;
    ...
    .section-sub {
        color: #6060a0; font-size: 0.85rem;
    ...
    [data-testid="stPageLink"]:hover { background: #1a1a30 !important; }
    [data-testid="stPageLink"] p {
        color: #9090c0 !important; font-size: 0.9rem !important;
    }
    ...
    with st.sidebar:
        ...
        <div style="text-align:center;padding:1.5rem 0 1rem;
                    border-bottom:1px solid #1e1e2e;margin-bottom:1.2rem">
            ...
            <div style="color:#5050a0;font-size:0.75rem;margin-top:0.3rem">
                2019 · Price Analytics
            </div>
        </div>
        <div style="color:#4040a0;font-size:0.7rem;letter-spacing:0.1em;
        ...
        st.markdown("---")
        st.markdown(
            "<p style='color:#3a3a6a;font-size:0.72rem;text-align:center;line-height:1.6'>"
            "Streamlit · scikit-learn<br>XGBoost · Airbnb NYC 2019</p>",
            unsafe_allow_html=True,
        )
